...
const Navbar = () => {
  ...
  return (
    <div className='flex pt-3 pb-4 justify-center gap-x-5 bg-[#222]'>
        ...
        <button onClick={()=>navigate('/piebackcalculator')} className='py-2 px-5 text-xl font-medium cursor-pointer rounded-xl text-[#f4f4f4] border-2 border-[#f4f4f4] '>Tab 3(Calculator)</button>      
    </div>
  )
}
