...
const ReferralLandingPage = () => {
  ...
  return (
    <div className="w-[1000px] py-7 mx-auto">
      ...
      <div className="bg-gradient-to-r from-[#DBEDFF] to-white border-[1px] border-slate-200/50 my-10 shadow-lg shadow-black/15 rounded-[25px] px-9 py-8">
      ...
      <div className="flex gap-5">
        <div className="w-1/2">
            <h3 className="text-xl font-medium text-[#222]">How it Works</h3>
            <div className="flex items-center gap-x-1.5 my-2">
                <div>
                  <BiDollarCircle size={50} color='#0071E3'/>
                </div>
                <div>
            ...
            <div className="flex items-center gap-x-2">
                <div>
                  <FaHandsHelping size={50} color='#0071E3'/>
                </div>
                <div>
        ...
        <div  className="w-1/2">
            <h3 className="text-xl font-medium text-[#222]">Partner Benifits</h3>
            <div className="flex items-center gap-x-1.5 my-2">
                <div>
                  <DiJira size={50} color='#0071E3'/>
                </div>
                <div>
            ...
            <div className="flex items-center gap-x-2">
                <div>
                  <GiTeacher size={50} color='#0071E3'/>
                </div>
                <div>
            ...
            <div className="flex items-center my-2 gap-x-2">
                <div>
                  <PiUserCircleCheckBold size={50} color='#0071E3'/>
                </div>
                <div>
