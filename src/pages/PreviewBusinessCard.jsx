  ...
  return (
    <div className='min-h-[calc(100vh-72px)] w-full flex flex-col justify-center gap-y-10 items-center'>
      ...
      <div className='rounded-[20px] max-w-[1440px] w-[99%] p-12 flex flex-col items-center gap-y-5 bg-gradient-to-r from-[#DBEDFF] to-[#FFFFFF] shadow-xl shadow-black/15 mb-24'>
        ...
        <button onClick={() => navigate(`/general-info-form/${cardId}/businessCard`)} className='bg-[#0071E3] py-2.5 px-[30px] rounded-[10px] text-xl font-medium text-white cursor-pointer hover:bg-blue-600/90 transition-all ease-in-out duration-200 hover:shadow-blue-500/30 hover:shadow-lg'>Schedule A Meeting</button>
      </div>
